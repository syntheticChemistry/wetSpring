...
> **Mar 11 update (V113):** 150+ primitives consumed. 0 local WGSL, 0 local derivative math (fully lean). 33 petalTongue scenario builders. standalone barraCuda v0.3.5. 370 experiments, 9,886+ checks.
