...
> **Mar 1 update (latest):** 93 ToadStool primitives consumed. 0 local WGSL, 0 local derivative math (fully lean).
> All ODE shaders use `BatchedOdeRK4<S>::generate_shader()` (Absorbed). S79 aligned (`1dd7e338`).
