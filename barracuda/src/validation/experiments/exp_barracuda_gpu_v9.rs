...
//! | Date | 2026-03-03 |
//! | Command | `cargo run --release --bin validate_barracuda_gpu_v9` |
//!
//! Provenance: barraCuda GPU primitive validation (V9 core)
...
/// Run the `validate_barracuda_gpu_v9` experiment, recording checks into `v`.
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_barracuda_gpu_v9");
    run(&mut v);
...
pub const SCENARIO: crate::validation::scenarios::registry::Scenario = crate::validation::scenarios::registry::Scenario {
    meta: crate::validation::scenarios::registry::ScenarioMeta {
        ...
        provenance_crate: "validate_barracuda_gpu_v9",
        provenance_date: "2026-05-20",
        description: "# Exp240: `BarraCuda` GPU v9 — Extended GPU Portability Proof",
    },
