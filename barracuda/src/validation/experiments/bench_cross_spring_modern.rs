...
/// Run the `benchmark_cross_spring_modern` experiment, recording checks into `v`.
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("benchmark_cross_spring_modern");
    run(&mut v);
...
pub const SCENARIO: crate::validation::scenarios::registry::Scenario = crate::validation::scenarios::registry::Scenario {
    meta: crate::validation::scenarios::registry::ScenarioMeta {
        id: "cross_spring_modern",
        track: crate::validation::scenarios::registry::Track::Science,
        tier: crate::validation::scenarios::registry::Tier::Rust,
        provenance_crate: "benchmark_cross_spring_modern",
        provenance_date: "2026-05-20",
        description: "Cross-spring modern benchmark — `ToadStool` primitive throughput",
    },
