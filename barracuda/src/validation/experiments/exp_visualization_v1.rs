...
use crate::visualization::scenarios::{self, benchmarks::TierResult};
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_visualization_v1");
    run(&mut v);
