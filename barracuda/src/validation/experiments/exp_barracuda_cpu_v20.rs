...
/// Run the `validate_barracuda_cpu_v20` experiment, recording checks into `v`.
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_barracuda_cpu_v20");
    run(&mut v);
...
pub const SCENARIO: crate::validation::scenarios::registry::Scenario = crate::validation::scenarios::registry::Scenario {
    meta: crate::validation::scenarios::registry::ScenarioMeta {
        id: "barracuda_cpu_v20",
        track: crate::validation::scenarios::registry::Track::Science,
        tier: crate::validation::scenarios::registry::Tier::Live,
        provenance_crate: "validate_barracuda_cpu_v20",
        provenance_date: "2026-05-20",
        description: "# Exp263: `BarraCuda` CPU v20 — V87 Vault + DF64 + Cross-Domain Validation",
    },
