...
pub fn run(v: &mut crate::validation::Validator) {
    ...
    v.check_pass(
        ...
        crate::ipc::songbird::discover_socket().is_none()
            || crate::ipc::songbird::discover_socket().is_some(),
    );
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_science_pipeline");
    run(&mut v);
