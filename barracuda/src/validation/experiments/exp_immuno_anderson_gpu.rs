...
/// Run the `validate_immuno_anderson_gpu` experiment, recording checks into `v`.
pub fn run(v: &mut crate::validation::Validator) {
    ...
    __rt.block_on(async {
        ...
        let tg = Instant::now();
        let gpu_sh_large =
            diversity_gpu::shannon_gpu(&gpu, &large_pop).or_exit("GPU Shannon large");
        let gpu_si_large =
            diversity_gpu::simpson_gpu(&gpu, &large_pop).or_exit("GPU Simpson large");
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_immuno_anderson_gpu");
    run(&mut v);
...
pub const SCENARIO: crate::validation::scenarios::registry::Scenario =
    crate::validation::scenarios::registry::Scenario {
        meta: crate::validation::scenarios::registry::ScenarioMeta {
            id: "immuno_anderson_gpu",
            track: crate::validation::scenarios::registry::Track::Science,
            tier: crate::validation::scenarios::registry::Tier::Both,
            provenance_crate: "validate_immuno_anderson_gpu",
            provenance_date: "2026-05-20",
            description: "# Exp277: Track 5 GPU Validation — Immunological Anderson on GPU",
        },
