...
use crate::bio::felsenstein::{TreeNode, encode_dna, log_likelihood};
...
/// Run the `validate_bootstrap` experiment, recording checks into `v`.
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_bootstrap");
    run(&mut v);
...
pub const SCENARIO: crate::validation::scenarios::registry::Scenario = crate::validation::scenarios::registry::Scenario {
    meta: crate::validation::scenarios::registry::ScenarioMeta {
        ...
        provenance_crate: "validate_bootstrap",
        provenance_date: "2026-05-20",
        description: "Validation: Wang 2021 RAWR bootstrap resampling (Exp031)",
    },
