...
use crate::visualization::live_pipeline::{LivePipelineSession, PipelineDomain};
...
pub fn run(v: &mut crate::validation::Validator) {
    ...
    let stages = crate::visualization::live_pipeline::amplicon_16s_stages();
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_petaltongue_live_v1");
    run(&mut v);
