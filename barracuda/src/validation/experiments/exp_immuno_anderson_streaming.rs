...
use crate::bio::{diversity, diversity_gpu, streaming_gpu};
...
/// Run the `validate_immuno_anderson_streaming` experiment, recording checks into `v`.
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_immuno_anderson_streaming");
    run(&mut v);
...
pub const SCENARIO: crate::validation::scenarios::registry::Scenario = crate::validation::scenarios::registry::Scenario {
    meta: crate::validation::scenarios::registry::ScenarioMeta {
        id: "immuno_anderson_streaming",
        track: crate::validation::scenarios::registry::Track::Science,
        tier: crate::validation::scenarios::registry::Tier::Both,
        provenance_crate: "validate_immuno_anderson_streaming",
        provenance_date: "2026-05-20",
        description: "# Exp278: Track 5 `ToadStool` Streaming Dispatch — Immunological Anderson",
    },
