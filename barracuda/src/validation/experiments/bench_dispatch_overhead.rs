...
use crate::validation::{self, OrExit};

const WARMUP: usize = 3;
const ITERS: usize = 10;

/// Run the `benchmark_dispatch_overhead` experiment, recording checks into `v`.
pub fn run(v: &mut crate::validation::Validator) {
    ...
    {
        use crate::bio::{decision_tree::DecisionTree, random_forest::RandomForest};
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("benchmark_dispatch_overhead");
    run(&mut v);
...
pub const SCENARIO: crate::validation::scenarios::registry::Scenario = crate::validation::scenarios::registry::Scenario {
    meta: crate::validation::scenarios::registry::ScenarioMeta {
        id: "dispatch_overhead",
        track: crate::validation::scenarios::registry::Track::Science,
        tier: crate::validation::scenarios::registry::Tier::Both,
        provenance_crate: "benchmark_dispatch_overhead",
        provenance_date: "2026-05-20",
        description: "Exp067: `ToadStool` Dispatch Overhead Profiling",
    },
