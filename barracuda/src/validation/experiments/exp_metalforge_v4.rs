...
use crate::bio::bistable_gpu::{BistableGpu, BistableOdeConfig};
...
/// Run the `validate_metalforge_v4` experiment, recording checks into `v`.
pub fn run(v: &mut crate::validation::Validator) {
    ...
    __rt.block_on(async {
        ...
        v.section("Phage Defense ODE: CPU ↔ GPU (4 vars, 11 params)");
        {
            ...
            let gpu_engine =
                PhageDefenseGpu::new(device.clone()).or_exit("PhageDefense GPU compile");
        ...
        v.section("Multi-Signal QS ODE: CPU ↔ GPU (7 vars, 24 params)");
        {
            ...
            let cpu_result =
                multi_signal::run_multi_signal(&y0, f64::from(n_steps) * dt, dt, &params);
            let cpu_finals: Vec<f64> = cpu_result.states().last().or_exit("MetalForge v4").to_vec();
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_metalforge_v4");
    run(&mut v);
...
pub const SCENARIO: crate::validation::scenarios::registry::Scenario =
    crate::validation::scenarios::registry::Scenario {
        meta: crate::validation::scenarios::registry::ScenarioMeta {
            ...
            provenance_crate: "validate_metalforge_v4",
            provenance_date: "2026-05-20",
            description: "Exp100: `metalForge` Cross-Substrate v4 — 20 Domains + NPU Dispatch",
        },
