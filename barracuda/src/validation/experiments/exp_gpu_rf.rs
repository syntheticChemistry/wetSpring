...
/// Run the `validate_gpu_rf` experiment, recording checks into `v`.
pub fn run(v: &mut crate::validation::Validator) {
    ...
    __rt.block_on(async {
        ...
        let rf =
            RandomForest::from_trees(vec![tree1, tree2, tree3, tree4, tree5], 3).or_exit("GPU RF");
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_gpu_rf");
    run(&mut v);
...
pub const SCENARIO: crate::validation::scenarios::registry::Scenario =
    crate::validation::scenarios::registry::Scenario {
        meta: crate::validation::scenarios::registry::ScenarioMeta {
            ...
            provenance_crate: "validate_gpu_rf",
            provenance_date: "2026-05-20",
            description: "Exp063: GPU Random Forest Batch Inference",
        },
