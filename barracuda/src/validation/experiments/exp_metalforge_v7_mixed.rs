...
fn validate_cross_substrate_qs(v: &mut Validator) {
    ...
    for scenario in scenarios {
        ...
        v.check_pass(
            ...
            mf_steps == crate::cast::usize_u64(direct.steps),
        );
...
fn validate_nucleus_coordination(v: &mut Validator) {
    ...
    v.check_pass(
        ...
        health["primal"] == crate::ipc::primal_names::SELF,
    );
...
pub fn run(v: &mut crate::validation::Validator) {
    ...
    validate_cross_substrate_bray_curtis(v);
    validate_cross_substrate_qs(v);
    validate_pcie_bypass_topology(v);
    validate_gpu_cpu_fallback(v);
    validate_nucleus_coordination(v);
    validate_biomeos_graph_e2e(v);
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_metalforge_v7_mixed");
    run(&mut v);
