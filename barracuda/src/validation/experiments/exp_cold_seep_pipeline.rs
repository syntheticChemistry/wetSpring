...
/// Run the `validate_cold_seep_pipeline` experiment, recording checks into `v`.
pub fn run(v: &mut crate::validation::Validator) {

    v.section("── S1: Data preparation ──");
    ...
    v.section("── S2: Diversity metrics ──");
    ...
    v.check_pass("all Shannon H' > 0", all_shannon.iter().all(|h| *h > 0.0));
    v.check_pass(
    ...
    v.check_count("Bray-Curtis condensed pairs", bc.len(), n_pairs);

    let bc_in_range = bc
        .iter()
        .all(|&d| (0.0..=1.0 + tolerances::EXACT).contains(&d));
    v.check_pass("all Bray-Curtis distances in [0, 1]", bc_in_range);
    ...
    v.section("── S4: Anderson spectral classification ──");
    ...
    #[cfg(feature = "gpu")]
    {
        ...
        v.check_pass("mean r > midpoint", mean_r > midpoint);
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_cold_seep_pipeline");
    run(&mut v);
...
pub const SCENARIO: crate::validation::scenarios::registry::Scenario = crate::validation::scenarios::registry::Scenario {
    meta: crate::validation::scenarios::registry::ScenarioMeta {
        id: "cold_seep_pipeline",
        track: crate::validation::scenarios::registry::Track::Pipeline,
        tier: crate::validation::scenarios::registry::Tier::Rust,
        provenance_crate: "validate_cold_seep_pipeline",
        provenance_date: "2026-05-20",
        description: "# Exp185: Cold Seep Metagenomes Through Sovereign Pipeline",
    },
