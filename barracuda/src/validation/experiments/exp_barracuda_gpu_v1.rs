...
/// Run the `validate_barracuda_gpu_v1` experiment, recording checks into `v`.
pub fn run(v: &mut crate::validation::Validator) {
    ...
    __rt.block_on(async {
        ...
        v.section("═══ GPU Domain 1: Diversity (FMR) ═══");
        {
            ...
            let gpu_shannon =
                diversity_gpu::shannon_gpu(&gpu, &abundances).or_exit("Barracuda GPU v1");
            let gpu_simpson =
                diversity_gpu::simpson_gpu(&gpu, &abundances).or_exit("Barracuda GPU v1");
        ...
        v.section("═══ GPU Domain 7: Random Forest ═══");
        {
            ...
            let rf =
                RandomForest::from_trees(vec![tree1, tree2, tree3], 3).or_exit("Barracuda GPU v1");
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_barracuda_gpu_v1");
    run(&mut v);
...
pub const SCENARIO: crate::validation::scenarios::registry::Scenario =
    crate::validation::scenarios::registry::Scenario {
        meta: crate::validation::scenarios::registry::ScenarioMeta {
            ...
            provenance_crate: "validate_barracuda_gpu_v1",
            provenance_date: "2026-05-20",
            description: "Exp064: `BarraCuda` GPU Parity v1 — Consolidated GPU Domain Validation",
        },
