...
/// Run the `validate_cpu_vs_gpu_v11` experiment, recording checks into `v`.
pub fn run(v: &mut crate::validation::Validator) {
    ...
    #[cfg(feature = "gpu")]
    {
        use crate::bio::diversity_gpu::{shannon_gpu, simpson_gpu};
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_cpu_vs_gpu_v11");
    run(&mut v);
