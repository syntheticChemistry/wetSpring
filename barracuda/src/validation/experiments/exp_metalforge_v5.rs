...
use crate::cast::{u64_usize, u128_f64, usize_f64};
...
fn validate_cooperation_mf(
    ...
    use crate::bio::cooperation_gpu::CooperationGpu;
...
fn validate_capacitor_mf(
    ...
    use crate::bio::capacitor_gpu::CapacitorGpu;
...
fn validate_feature_table_mf(
    ...
    use crate::bio::feature_table_gpu;
...
fn validate_robinson_foulds_mf(
    ...
    use crate::bio::robinson_foulds_gpu;
...
fn validate_neighbor_joining_mf(
    ...
    use crate::bio::neighbor_joining_gpu;
...
fn validate_reconciliation_mf(
    ...
    use crate::bio::reconciliation_gpu;
...
fn validate_molecular_clock_mf(
    ...
    use crate::bio::molecular_clock_gpu;
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_metalforge_v5");
    run(&mut v);
