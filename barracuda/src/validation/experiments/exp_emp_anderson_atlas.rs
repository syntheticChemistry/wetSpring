...
/// Run the `validate_emp_anderson_atlas` experiment, recording checks into `v`.
...
fn check_nucleus_available() -> bool {
    use crate::ipc::{discover, primal_names};
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_emp_anderson_atlas");
    run(&mut v);
...
pub const SCENARIO: crate::validation::scenarios::registry::Scenario = crate::validation::scenarios::registry::Scenario {
    meta: crate::validation::scenarios::registry::ScenarioMeta {
        id: "emp_anderson_atlas",
        track: crate::validation::scenarios::registry::Track::Science,
        tier: crate::validation::scenarios::registry::Tier::Live,
        provenance_crate: "validate_emp_anderson_atlas",
        provenance_date: "2026-05-20",
        description: "# Exp256: EMP-Scale Anderson Atlas — 30K Biome QS Classification",
    },
