...
use crate::visualization::stream::{BackpressureConfig, StreamSession};
...
/// Run the `validate_visualization_v2` experiment, recording checks into `v`.
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_visualization_v2");
    run(&mut v);
...
pub const SCENARIO: crate::validation::scenarios::registry::Scenario = crate::validation::scenarios::registry::Scenario {
    meta: crate::validation::scenarios::registry::ScenarioMeta {
        ...
        provenance_crate: "validate_visualization_v2",
        provenance_date: "2026-05-20",
        description: "Validate all visualization scenario builders and streaming infrastructure",
    },
