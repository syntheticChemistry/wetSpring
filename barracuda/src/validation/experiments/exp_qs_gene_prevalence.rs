...
pub fn run(v: &mut crate::validation::Validator) {
    ...
    let organisms = vec![
        ...
        OrganismQs {
            ...
            domain: "Bacteria",
            primary_habitat: "biofilm/soil/clinical",
            geometry: "3D_dense",
            n_qs_systems: 3,
        ...
        OrganismQs {
            ...
            domain: "Bacteria",
            primary_habitat: "squid light organ (biofilm)",
            geometry: "3D_dense",
            n_qs_systems: 2,
        ...
        OrganismQs {
            ...
            domain: "Bacteria",
            primary_habitat: "biofilm/gut/estuary",
            geometry: "3D_dense",
            n_qs_systems: 3,
        ...
        OrganismQs {
            name: "Vibrio harveyi",
            domain: "Bacteria",
            primary_habitat: "marine particle/biofilm",
            geometry: "3D_dense",
            n_qs_systems: 3,
        ...
        OrganismQs {
            ...
            domain: "Bacteria",
            primary_habitat: "biofilm/skin/clinical",
            geometry: "3D_dense",
            n_qs_systems: 1,
            qs_genes: "agrBDCA",
            qs_active: true,
        ...
        OrganismQs {
            ...
            domain: "Bacteria",
            primary_habitat: "rhizosphere/nodule",
            geometry: "3D_dense",
            n_qs_systems: 2,
        ...
        OrganismQs {
            ...
            domain: "Bacteria",
            primary_habitat: "soybean rhizosphere/nodule",
            geometry: "3D_dense",
            n_qs_systems: 1,
        ...
        OrganismQs {
            ...
            domain: "Bacteria",
            primary_habitat: "rhizosphere/endophyte",
            geometry: "3D_dense",
            n_qs_systems: 1,
        ...
        OrganismQs {
            ...
            domain: "Bacteria",
            primary_habitat: "ocean surface (colonial plankton)",
            geometry: "3D_dilute",
            n_qs_systems: 0,
            qs_genes: "NONE confirmed",
            qs_active: false,
        ...
        OrganismQs {
            ...
            domain: "Bacteria",
            primary_habitat: "marine snow/particle",
            geometry: "3D_dense",
            n_qs_systems: 3,
            qs_genes: "luxLM, luxS, cqsA",
            qs_active: true,
        ...
        OrganismQs {
            ...
            domain: "Bacteria",
            primary_habitat: "hot spring (thin mat)",
            geometry: "2D_mat",
            n_qs_systems: 0,
        ...
        OrganismQs {
            ...
            domain: "Archaea",
            primary_habitat: "hot spring (surface/mat)",
            geometry: "2D_mat",
            n_qs_systems: 0,
            qs_genes: "NONE confirmed",
            qs_active: false,
        ...
        OrganismQs {
            ...
            domain: "Bacteria",
            primary_habitat: "surface/desiccated",
            geometry: "2D_surface",
            n_qs_systems: 0,
            qs_genes: "NONE",
            qs_active: false,
        ...
        OrganismQs {
            ...
            domain: "Bacteria",
            primary_habitat: "gut (3D mucus layer)",
            geometry: "3D_dense",
            n_qs_systems: 1,
        ...
        OrganismQs {
            ...
            domain: "Bacteria",
            primary_habitat: "gut (3D biofilm)",
            geometry: "3D_dense",
            n_qs_systems: 0,
        ...
        OrganismQs {
            ...
            domain: "Bacteria",
            primary_habitat: "dental biofilm (3D)",
            geometry: "3D_dense",
            n_qs_systems: 1,
        ...
        OrganismQs {
            ...
            domain: "Bacteria",
            primary_habitat: "lake (colonial bloom)",
            geometry: "3D_dense",
            n_qs_systems: 0,
        ...
        OrganismQs {
            ...
            domain: "Bacteria",
            primary_habitat: "lake (free-living plankton)",
            geometry: "3D_dilute",
            n_qs_systems: 0,
            qs_genes: "NONE",
            qs_active: false,
        ...
        OrganismQs {
            ...
            domain: "Bacteria",
            primary_habitat: "sediment/biofilm (3D)",
            geometry: "3D_dense",
            n_qs_systems: 0,
        ...
        OrganismQs {
            ...
            domain: "Fungi",
            primary_habitat: "biofilm/mucosa (3D)",
            geometry: "3D_dense",
            n_qs_systems: 1,
    ...
    println!(
        "  {:15} {:>5} {:>5} {:>8} {:>10} {:>8}",
        "geometry", "n", "w/QS", "QS%", "mean_sys", "mean_Mb"
    );
    println!(
        "  {:-<15} {:-<5} {:-<5} {:-<8} {:-<10} {:-<8}",
        "", "", "", "", "", ""
    ...
    for &geom in &geometry_classes {
        ...
        println!("  {geom:15} {n:>5} {with_qs:>5} {pct:>7.1}% {mean_sys:>10.2} {mean_mb:>7.1}");
    ...
    println!(
        "    → {} (dense {:.0}× more QS than dilute)",
        if pred1 { "CONFIRMED" } else { "REJECTED" },
        if dilute_3d.3 > 0.0 {
            dense_3d.3 / dilute_3d.3
        } else {
            f64::INFINITY
        }
    );
    ...
    println!(
        "    → {}",
        if pred3 {
            "CONFIRMED — zero QS in obligate plankton"
        } else {
            "PARTIAL"
        }
    );
    ...
    for o in &organisms {
        let qs_tag = if o.n_qs_systems > 0 {
            format!("{}", o.n_qs_systems)
        } else {
            "---".to_string()
        };
        let gene_short = if o.qs_genes.len() > 25 {
            &o.qs_genes[..25]
        } else {
            o.qs_genes
        };
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_qs_gene_prevalence");
    run(&mut v);
