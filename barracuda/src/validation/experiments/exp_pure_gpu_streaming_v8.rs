...
//!
//! Provenance: Pure GPU streaming pipeline (V8)

use std::time::Instant;

use crate::bio::{diversity, diversity_gpu, kriging, pcoa, pcoa_gpu};
use crate::gpu::GpuF64;
use crate::tolerances;
use crate::validation::OrExit;
use crate::validation::Validator;

/// Run the `validate_pure_gpu_streaming_v8` experiment, recording checks into `v`.
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_pure_gpu_streaming_v8");
    run(&mut v);
...
pub const SCENARIO: crate::validation::scenarios::registry::Scenario = crate::validation::scenarios::registry::Scenario {
    meta: crate::validation::scenarios::registry::ScenarioMeta {
        id: "pure_gpu_streaming_v8",
        track: crate::validation::scenarios::registry::Track::Science,
        tier: crate::validation::scenarios::registry::Tier::Both,
        provenance_crate: "validate_pure_gpu_streaming_v8",
        provenance_date: "2026-05-20",
        description: "# Exp255: Pure GPU Streaming v8 — Unidirectional Pipeline Proof",
    },
