...
use crate::bio::multi_signal_gpu::MultiSignalGpu;
...
use crate::bio::phage_defense_gpu::PhageDefenseGpu;
use crate::bio::qs_biofilm::{self, QsBiofilmParams};
use crate::bio::unifrac_gpu::UniFracGpu;
use crate::cast;
...
/// Run the `validate_streaming_ode_phylo` experiment, recording checks into `v`.
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_streaming_ode_phylo");
    run(&mut v);
