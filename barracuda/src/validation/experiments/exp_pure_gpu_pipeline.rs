...
use crate::bio::{diversity, diversity_gpu, pcoa, pcoa_gpu, spectral_match_gpu, stats_gpu};
...
/// Run the `validate_pure_gpu_pipeline` experiment, recording checks into `v`.
pub fn run(v: &mut crate::validation::Validator) {
    ...
    __rt.block_on(async {
        ...
        let t3 = Instant::now();
        let gpu_pcoa =
            pcoa_gpu::pcoa_gpu(&gpu, &gpu_bray, N_SAMPLES, N_AXES).or_exit("GPU pipeline");
        ...
        println!(
            "  Stage 3: {stage3_us:.0} µs (PCoA {N_SAMPLES}×{N_AXES}, prop_var={prop_sum:.3})"
        );
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_pure_gpu_pipeline");
    run(&mut v);
...
pub const SCENARIO: crate::validation::scenarios::registry::Scenario =
    crate::validation::scenarios::registry::Scenario {
        meta: crate::validation::scenarios::registry::ScenarioMeta {
            id: "pure_gpu_pipeline",
            track: crate::validation::scenarios::registry::Track::Pipeline,
            tier: crate::validation::scenarios::registry::Tier::Both,
            provenance_crate: "validate_pure_gpu_pipeline",
            provenance_date: "2026-05-20",
            description: "Exp075: Pure GPU Multi-Stage Analytics Pipeline",
        },
