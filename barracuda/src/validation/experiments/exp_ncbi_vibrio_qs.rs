...
use crate::bio::ncbi_data::{VibrioAssembly, load_vibrio_assemblies};
#[cfg(feature = "gpu")]
...
pub fn run(v: &mut crate::validation::Validator) {
    ...
    #[cfg(feature = "gpu")]
    {
        ...
        let config = OdeSweepConfig {
            n_batches: crate::cast::usize_u32(n),
            n_steps: N_STEPS,
            h: DT,
            t0: 0.0,
            clamp_max: 100.0,
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_ncbi_vibrio_qs");
    run(&mut v);
