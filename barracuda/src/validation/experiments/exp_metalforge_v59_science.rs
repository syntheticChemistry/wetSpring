...
/// Run the `validate_metalforge_v59_science` experiment, recording checks into `v`.
pub fn run(v: &mut crate::validation::Validator) {
    let t_total = Instant::now();

    validate_diversity_parity(v);
    validate_bray_curtis_parity(v);
    validate_anderson_parity(v);
    validate_pipeline_summary(v);
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_metalforge_v59_science");
    run(&mut v);
...
pub const SCENARIO: crate::validation::scenarios::registry::Scenario = crate::validation::scenarios::registry::Scenario {
    meta: crate::validation::scenarios::registry::ScenarioMeta {
        id: "metalforge_v59_science",
        track: crate::validation::scenarios::registry::Track::Science,
        tier: crate::validation::scenarios::registry::Tier::Both,
        provenance_crate: "validate_metalforge_v59_science",
        provenance_date: "2026-05-20",
        description: "Exp192: `metalForge` V59 Cross-Substrate — CPU↔GPU Parity for Science Domains",
    },
