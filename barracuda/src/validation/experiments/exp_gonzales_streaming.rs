...
/// Run the `validate_gonzales_streaming` experiment, recording checks into `v`.
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_gonzales_streaming");
    run(&mut v);
...
pub const SCENARIO: crate::validation::scenarios::registry::Scenario = crate::validation::scenarios::registry::Scenario {
    meta: crate::validation::scenarios::registry::ScenarioMeta {
        id: "gonzales_streaming",
        track: crate::validation::scenarios::registry::Track::Pharmacology,
        tier: crate::validation::scenarios::registry::Tier::Both,
        provenance_crate: "validate_gonzales_streaming",
        provenance_date: "2026-05-20",
        description: "# Exp285: `ToadStool` Streaming — Gonzales Reproductions",
    },
