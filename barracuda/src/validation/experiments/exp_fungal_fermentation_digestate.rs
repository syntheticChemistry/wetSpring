...
//! | Type | Analytical |
//! | Date | 2026-03-23 |
//! | Command | `cargo run --bin validate_fungal_fermentation_digestate` |
//!
//! Provenance: Fungal fermentation digestate kinetics (Track 6)

use crate::bio::diversity;
use crate::bio::kinetics::monod;
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_fungal_fermentation_digestate");
    run(&mut v);
