...
//! | Diversity (Pielou) | wetSpring | `crate::bio::diversity` |
//! | `Validator` | hotSpring | `crate::validation` |
//!
//! # Provenance
//!
//! | Field | Value |
...
/// Run the `validate_skin_anderson_s79` experiment, recording checks into `v`.
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_skin_anderson_s79");
    run(&mut v);
