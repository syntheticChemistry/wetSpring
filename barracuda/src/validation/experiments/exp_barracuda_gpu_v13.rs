...
/// Run the `validate_barracuda_gpu_v13` experiment, recording checks into `v`.
pub fn run(v: &mut crate::validation::Validator) {
    ...
    #[cfg(feature = "gpu")]
    {
        ...
        let cpu_cos = crate::bio::spectral_match::cosine_similarity(
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_barracuda_gpu_v13");
    run(&mut v);
