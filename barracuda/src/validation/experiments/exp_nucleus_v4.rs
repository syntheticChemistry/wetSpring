...
pub fn run(v: &mut crate::validation::Validator) {
    ...
    for _ in 0..n_iterations {
        ...
        let result = crate::ipc::dispatch::dispatch("science.diversity", &params)
    ...
    let ipc_result = crate::ipc::dispatch::dispatch("science.diversity", &ipc_params)
        .or_exit("unexpected error");
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_nucleus_v4");
    run(&mut v);
