...
use crate::bio::bistable::{BistableParams, bifurcation_scan, run_bistable};
...
pub fn run(v: &mut crate::validation::Validator) {
    ...
    v.check(
        ...
        c_ss,
        1.634,
        tolerances::ODE_SIGNAL_SS,
    );
    check_non_negative(v, &r, "S2");
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_bistable");
    run(&mut v);
