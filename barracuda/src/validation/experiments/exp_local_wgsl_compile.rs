...
use crate::bio::ode_sweep_gpu::{OdeSweepConfig, OdeSweepGpu};
...
/// Run the `validate_local_wgsl_compile` experiment, recording checks into `v`.
    ...
    __rt.block_on(async {
        ...
        v.section("BatchedOdeRK4F64 via OdeSweepGpu — Lean wrapper");
        {
            ...
            let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
                ...
                let params = vec![
                    0.5, 1e9, 0.01, 0.1, 0.05, 0.3, 0.1, 2.0, 0.1, 0.2, 0.1, 0.05, 0.1, 0.3, 0.5,
                    2.0, 0.05, // batch 0
                    0.5, 1e9, 0.01, 0.1, 0.05, 0.3, 0.1, 2.0, 0.1, 0.2, 0.1, 0.05, 0.1, 0.3, 0.5,
                    2.0, 0.05, // batch 1
                ];
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_local_wgsl_compile");
    run(&mut v);
...
pub const SCENARIO: crate::validation::scenarios::registry::Scenario =
    crate::validation::scenarios::registry::Scenario {
        meta: crate::validation::scenarios::registry::ScenarioMeta {
            id: "local_wgsl_compile",
            track: crate::validation::scenarios::registry::Track::Science,
            tier: crate::validation::scenarios::registry::Tier::Both,
            provenance_crate: "validate_local_wgsl_compile",
            provenance_date: "2026-05-20",
            description: "Exp096: `ToadStool` Bio Op Absorption Validation",
        },
