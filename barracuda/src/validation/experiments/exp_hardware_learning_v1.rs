...
/// Run the `validate_hardware_learning_v1` experiment, recording checks into `v`.
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_hardware_learning_v1");
    run(&mut v);
...
pub const SCENARIO: crate::validation::scenarios::registry::Scenario = crate::validation::scenarios::registry::Scenario {
    meta: crate::validation::scenarios::registry::ScenarioMeta {
        id: "hardware_learning_v1",
        track: crate::validation::scenarios::registry::Track::Science,
        tier: crate::validation::scenarios::registry::Tier::Both,
        provenance_crate: "validate_hardware_learning_v1",
        provenance_date: "2026-05-20",
        description: "# Exp362: Hardware Learning Prototype — Probe-Calibrate-Route-Apply",
    },
