...
/// Run the `validate_fajgenbaum_pathway` experiment, recording checks into `v`.
pub fn run(v: &mut crate::validation::Validator) {

    validate_pathway_identification(v);
    validate_drug_matching(v);
    validate_score_matrix(v);
    validate_discovery_logic(v);

}

/// Bridge into [`primalspring::validation::ValidationResult`] for UniBin dispatch.
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("validate_fajgenbaum_pathway");
    run(&mut v);
...
pub const SCENARIO: crate::validation::scenarios::registry::Scenario = crate::validation::scenarios::registry::Scenario {
    meta: crate::validation::scenarios::registry::ScenarioMeta {
        id: "fajgenbaum_pathway",
        track: crate::validation::scenarios::registry::Track::Science,
        tier: crate::validation::scenarios::registry::Tier::Rust,
        provenance_crate: "validate_fajgenbaum_pathway",
        provenance_date: "2026-05-20",
        description: "# Exp157: Fajgenbaum Pathway Scoring — PI3K/AKT/mTOR → Sirolimus",
    },
