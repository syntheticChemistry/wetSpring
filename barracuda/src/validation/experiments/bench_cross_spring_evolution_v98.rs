...
/// Run the `benchmark_cross_spring_evolution_v98` experiment, recording checks into `v`.
pub fn run(v: &mut crate::validation::Validator) {
    ...
    #[cfg(feature = "gpu")]
    {
        ...
        match rt.block_on(crate::gpu::GpuF64::new()) {
            Ok(gpu) => {
...
pub fn run_as_scenario(result: &mut primalspring::validation::ValidationResult) {
    let mut v = crate::validation::Validator::silent("benchmark_cross_spring_evolution_v98");
    run(&mut v);
...
pub const SCENARIO: crate::validation::scenarios::registry::Scenario = crate::validation::scenarios::registry::Scenario {
    meta: crate::validation::scenarios::registry::ScenarioMeta {
        ...
        provenance_crate: "benchmark_cross_spring_evolution_v98",
        provenance_date: "2026-05-20",
        description: "# Exp320: Cross-Spring Modern Evolution Benchmark (V98+)",
    },
