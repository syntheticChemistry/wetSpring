...
//! lower incomplete gamma function.  These exist here until `barracuda`
//! exposes a CPU-only `math` feature, at which point this module should
//! be deleted and callers should migrate to `barracuda::math`.
//!
//! # References
//!
