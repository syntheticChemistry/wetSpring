...
1,476 CPU quantitative checks across 71 validation binaries — all pass.
...
Each stage has unit tests (1,638 total, 94% barracuda line coverage), end-to-end
...
cd barracuda
cargo test --release          # 1,638 tests (1,404 barracuda lib + 234 forge lib)
