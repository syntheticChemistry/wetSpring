...
**Status:** Phase 27 — expanded CPU↔GPU parity (k-mer, UniFrac, phage defense), local WGSL evolution; 740 tests, 99 experiments
...
├── CONTROL_EXPERIMENT_STATUS.md   ← experiment status tracker (99 experiments)
