...
| File | Purpose |
|------|---------|
| `CROSS_SPRING_SHADER_EVOLUTION.md` | 700+ WGSL shader provenance map (cross-spring, ToadStool S71+++ universal precision) |

## Archive

Superseded handoffs in `handoffs/archive/` (V7-V84, API report, rewire, cross-spring provenance, NestGate data types — 67 files).
