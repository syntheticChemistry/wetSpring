...
|---------|------|------|-------|
| **V157** | `handoffs/WETSPRING_V157_DEEP_DEBT_EVOLUTION_HANDOFF_MAY10_2026.md` | May 10 | **Deep debt evolution + upstream handoff**: IPC timeouts centralized, GPU API evolved (submit_and_poll removed), shared validation harness, skunkBat wired, biomeOS v3.51 consumed, CI cross-sync, 3 gaps closed (12 open/10 resolved). |
