...
**Updated**: 2026-05-16 (V169: Wave 17 signal adoption — nest.store, nest.commit dispatch, primal.announce consumed, registry 451. barraCuda v0.4.0. coralReef v0.1.0 in niche. 384 experiments indexed (381 completed + 3 PROPOSED), **367** binaries (**345** barracuda + **22** forge), 5,900+ checks, **1,962** lib tests **+ 97 integration + 18 IPC** roundtrip (0 failures). 12 paper notebooks. 63/63 papers. 2 primal gaps open (deployment-only), 20 resolved/closed.)
