...
| Size | ~586 MB total, ~102 MB for 4 representative samples |
...
| Accession | Condition | Timepoint | Reads | File Size |
|-----------|-----------|-----------|-------|-----------|
| SRR29127218 | N. oculata culture | Day 1 | 87,300 | 26 MB |
| SRR29127209 | N. oculata culture | Day 14 | 93,649 | 27 MB |
| SRR29127205 | B. plicatilis culture | Day 1 | 97,256 | 28 MB |
| SRR29127215 | B. plicatilis culture | Day 14 | 66,312 | 21 MB |
...
## Results (10 samples, 4 BioProjects, 2,663,810 reads)

| Sample | Reads | QC Retained | ASVs | Shannon | Simpson |
|--------|-------|-------------|------|---------|---------|
| Nanno Day 1 (1114688) | 87,300 | 89.9% | 153 | 3.188 | 0.922 |
| Nanno Day 14 (1114688) | 93,649 | 89.6% | 302 | 3.544 | 0.935 |
| Brachio Day 1 (1114688) | 97,256 | 88.6% | 256 | 4.100 | 0.960 |
| Brachio Day 14 (1114688) | 66,312 | 89.7% | 331 | 2.878 | 0.910 |
| Nanno phyco-1 (629095) | 87,440 | 95.7% | 415 | 2.552 | 0.868 |
| Nanno phyco-2 (629095) | 128,196 | 94.7% | 361 | 2.525 | 0.814 |
| Cyano-tox-1 (1178324) | 638,313 | 88.8% | 488 | 2.453 | 0.779 |
| Cyano-tox-2 (1178324) | 1,201,284 | 89.4% | 438 | 4.767 | 0.942 |
| LakeErie-1 (516219) | 122,585 | 97.4% | 420 | 2.118 | 0.805 |
| LakeErie-2 (516219) | 141,475 | 97.1% | 419 | 2.726 | 0.869 |
...
`cargo run --bin validate_public_benchmarks` — 97/97 checks passed

## Data Location

```
data/public_benchmarks/
├── PRJNA1114688/   N. oculata + B. plicatilis (4 samples, 102 MB)
...
- 10 samples from 4 independent BioProjects, 3 labs
- 2,663,810 total reads processed
