...
**Status**: Phase 65 — 5,061+ checks (1,783 GPU on RTX 4070, 60 NPU on AKD1000), ALL PASS (1,103 tests, 211 experiments, ToadStool S68+ aligned (`e96576ee`), 79 primitives consumed, 0 local WGSL/derivative/regression, barracuda always-on, 92 named tolerances with full provenance, 0 ad-hoc magic numbers, clippy pedantic CLEAN, 0 Passthrough, V65 `io::nanopore` + Exp196a-c pre-hardware, 39/39 three-tier, 52/52 papers, 95.46% line / 93.54% fn / 94.99% branch)
...
| Metric | Value |
|--------|-------|
| CPU validation | 1,476+/1,476+ PASS — 47 modules, 211 experiments, 25 domains + 6 ODE flat + 3 layout + 13 GPU-promoted |
| GPU validation | 1,783+/1,783+ PASS — 79 ToadStool primitives (S68+ `e96576ee`, always-on), 0 local WGSL (fully lean) |
...
| Rust modules | 47 CPU + 42 GPU, 1,103 tests (977 barracuda lib + 60 integration + 19 doc + 47 forge) |
...
| Handoffs | Sixty-five delivered (v1–v65) |
...
|----------|----------|-------------|
| CONTROL_EXPERIMENT_STATUS.md | `../` | 211 experiments, 5,061+ validation checks, 1,103 tests |
...
| Handoff (V65) | `../wateringHole/handoffs/WETSPRING_TOADSTOOL_V65_PROGRESSION_BENCHMARK_HANDOFF_FEB27_2026.md` | Current ToadStool handoff |
